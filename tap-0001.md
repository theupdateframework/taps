...
For a TAP to be accepted it must meet certain minimum criteria. It must be a clear and complete description of the proposed enhancement. The enhancement must represent a net improvement.  The proposed implementation, if applicable, must be solid and must not complicate the framework unduly.  Finally, a proposed enhancement must be "practical" in order to be accepted by the BDFL. (However, "practical" is an imprecise term; it may be defined as whatever is acceptable to the BDFL.  This logic is intentionally circular.)  See [TAP 2](https://github.com/theupdateframework/taps/blob/master/tap-0002.md) for standard library module acceptance criteria.
