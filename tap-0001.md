...
TAP stands for TUF Augmentation Proposal (heavily modeled on the PEP process from Python).  A TAP is a design document providing information to the TUF community, or describing a new feature for TUF or its processes or environment.  The TAP should provide a concise technical specification of the feature and a rationale for the feature.
